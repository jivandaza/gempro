...
const ProductosPulseraOro = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:3000/producto", {
      ...
      .then((res) => res.json())
      .then((datos) => {
        const productosFiltrados = datos.data.filter(producto => ((producto.ID_CATEGORIA === '207')&& producto.CANTIDAD>0));
  ...
  return (
    <div>
      <Navbar />
      <h3 className="titlePRODUCTOS">PULSERAS</h3>
...
export default ProductosPulseraOro;

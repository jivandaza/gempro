...
const ProductosCadenasPlata = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:3000/producto", {
      ...
      .then((res) => res.json())
      .then((datos) => {
        const productosFiltrados = datos.data.filter(producto => ((producto.ID_CATEGORIA === '202')&& producto.CANTIDAD>0));
...
export default ProductosCadenasPlata;

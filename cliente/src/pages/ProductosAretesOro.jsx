...
const ProductosAretes = () => {
  ...
  useEffect(() => {
    fetch("http://localhost:3000/producto", {
      ...
      .then((res) => res.json())
      .then((datos) => {
        const productosFiltrados = datos.data.filter(producto => ((producto.ID_CATEGORIA === '210')&& producto.CANTIDAD>0));
  ...
  return (
    <div>
      <Navbar />
      <h3 className="titlePRODUCTOS">ARETES</h3>
...
export default ProductosAretes;
